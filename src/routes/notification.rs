...
use crate::{error::ApiError, models::Account, notification::NotificationData, AppState};
...
async fn notifications(account: Account) -> NotificationTemplate {
    NotificationTemplate { account: Some(account) }
}
